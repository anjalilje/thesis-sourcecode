...
parser.add_argument('-nn', '--net_name', nargs='?', type=str, default="vgg16arch", help='Name of the network')
...
## Psoriasis: 0-5235
## Eczema: 5236-9515
## Acne_vulgaris: 9516-10443
## Rosacea: 10444-11727
## Mycosis_fungoides: 11728-15663
...
print("Initial learning rate:", learning_rate, file = f)
...
for epoch_i in epoch_range:
    ...
    for i, batch_idxs in enumerate(batch(all_indices,batch_size)):
        ...
        feed = {x: batch_xs, m: masks, y: labels, dropout_rate: 0.5}
    ...
    for i, batch_val_idxs in enumerate(batch(all_val_indices,64)):
        ...
        batch_val_xs = batch_val_xs/255.0

        labels_val, masks_val = generate_masks_and_labels(batch_val_ys)

        feed = {x: batch_val_xs, m: masks_val, y: labels_val, dropout_rate: 0.0}
